// WARNING!!! This piece of technology is obsolete and cannot be used with dynamic OData Service token if it is changed to an other string than 'odata.svc'.
...
SenseNet.Portal.UI.Controls.TagList.prototype = {
    initialize: function() {
        ...
        $("#" + btnId).click(function() {
            ...
            $.post(window.location.protocol + '//' + window.location.host + "/OData.svc/('root')/TagManagerAddTag",
            "models=[" + JSON.stringify({ tag: inputValue, id: currentId }) + "]",
            function () { alert("New tag (" + inputValue + ") has been added!"); });
