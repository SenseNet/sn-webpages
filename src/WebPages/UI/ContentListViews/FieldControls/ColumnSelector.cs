    ...
    public class ColumnSelector : FieldControl
    {
        ...
        protected void ColumnList_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            if (ha != null)
            {
                ...
                {
                    ha.Items.Add(new ListItem(SenseNetResourceManager.Current.GetString("ManageFields", "HAlign-" + haName), haName));
                    index++;
            ...
            if (wm != null)
            {
                ...
                {
                    wm.Items.Add(new ListItem(SenseNetResourceManager.Current.GetString("ManageFields", "Wrap-" + wmName), wmName));
                    index++;
            ...
            if (afs != null)
            {
                ...
                if (lblType != null && !string.IsNullOrEmpty(afs.ShortName))
                    lblType.Text = SenseNetResourceManager.Current.GetString("ManageFields", afs.ShortName);
            }
