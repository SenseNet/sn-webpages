...
<head>
    ...
    <script src="/Root/Global/scripts/jquery/jquery-migrate.js"></script>
    <link href="/Root/Global/styles/jqueryui/jquery-ui.css" rel="Stylesheet" type="text/css" media="all" />
    <link href="/Root/Global/styles/widgets.css" rel="Stylesheet" type="text/css" media="all" />
    <link href="/Root/Global/styles/jqueryui/jquery-ui-sntheme.css" rel="Stylesheet" type="text/css" media="all" />
...
<body class="sn-exploretree-body sn-admin">
        <form id="form1" runat="server">
            <div id="sn-exploretree-controls" class="ui-helper-clearfix">
                ...
                <span id="sn-exploretree-closebutton" class="sn-button sn-submit" onclick="parent.location = parent.frames['ExploreFrame'].location;"><%=GetGlobalResourceObject("Explore", "Close")%></span>
                <div id="sn-exploretree-treeactions">
                    <input type="radio" id="sn-treeaction-explore" name="sn-exploretree-treeactions" value="Explore" checked="checked" /><label for="sn-treeaction-explore"><%=GetGlobalResourceObject("Explore", "Explore")%></label> 
                    <input type="radio" id="sn-treeaction-browse" name="sn-exploretree-treeactions" value="Browse" /><label for="sn-treeaction-browse"><%=GetGlobalResourceObject("Explore", "Browse")%></label> 
                    <input type="radio" id="sn-treeaction-edit" name="sn-exploretree-treeactions" value="Edit" /><label for="sn-treeaction-edit"><%=GetGlobalResourceObject("Explore", "Edit")%></label>
                </div>
                ...
                <dl class="sn-exploretree-info sn-admin ui-widget ui-helper-reset ui-helper-clearfix">
                    <dt><%=GetGlobalResourceObject("Explore", "Content")%></dt><dd><input type="text" readonly="readonly" id="sn-exploretree-contentname" /></dd>
                    <dt><%=GetGlobalResourceObject("Explore", "Action")%></dt><dd><span id="sn-exploretree-actionname"></span></dd>
                </dl>
                <div id="sn-exploretree-search">
                    ...
                    <input id="sn-exploretree-searchbutton" class="sn-button sn-submit" type="button" value="<%=GetGlobalResourceObject("Explore", "Search")%>" onclick="ExploreSearch();" />
                </div>
            </div>            
            <div id="sn-exploretree-treediv" class="ui-widget ui-widget-content ui-corner-all">
                <div id="sn-exploretree-treerootdiv">
                    <%=GetGlobalResourceObject("Explore", "TreeRoot")%>
                ...
                <div id="sn-exploretree-treerootshowall">
                    <label for="sn-exploretree-treeshowall"><input id="sn-exploretree-treeshowall" type="checkbox" onclick="SN.ExploreTree.ToggleHidden(this.checked)" checked="checked" /><%=GetGlobalResourceObject("Explore", "ShowSystemFiles")%></label>
                </div>
