...
<div style="width: 310px;">
    ...
    <asp:Repeater ID="UploadedFiles" runat="server">
        <ItemTemplate>
            <asp:Button ID="DeleteFile" runat="server" Text="X" CommandName='<%# DataBinder.Eval(Container.DataItem, "Path")%>'
                ToolTip="<%$ Resources:Controls,RemoveUploadedFile %>" />
    ...
    <asp:Button ID="UploadButton" runat="server" Text="<%$ Resources:Controls,Upload %>"
        CssClass="sn-submit" />
</div>
