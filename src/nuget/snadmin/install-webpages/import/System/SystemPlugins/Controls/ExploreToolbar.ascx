...
<sn:Toolbar runat="server">
    <sn:ToolbarItemGroup Align="Left" runat="server">
        ...
        <sn:ActionMenu runat="server" IconUrl="/Root/Global/images/icons/16/wizard.png" Scenario="ExploreActions" ContextInfoID="myContext" Text="<%$ Resources:Controls,Actions %>"><%= HttpContext.GetGlobalResourceObject("Scenario", "ActionsMenuDisplayName")%></sn:ActionMenu>
    </sn:ToolbarItemGroup>
