            ...
            <table class="sn-listgrid ui-widget-content">
                <thead>
                    <tr class="ui-widget-content">
                        ...
                        <th class="sn-lg-col-2 ui-state-default" style="width:350px"><%# HttpContext.GetGlobalResourceObject("ProxyPurge", "Result")%></th>
                    </tr>
                </thead>
                <tbody>
...
<div class="sn-pt-body-border ui-widget-content sn-dialog-buttons">
    <div class="sn-pt-body">
        <sn:BackButton Text="<%$ Resources:ProxyPurge,Done %>" ID="DoneButton" runat="server" CssClass="sn-submit" />
    </div>
</div>