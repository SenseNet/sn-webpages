...
<sn:MessageControl ID="RestoreMessage" runat="server" >
        ...
        <div class="sn-pt-body-border ui-widget-content">
            <div class="sn-pt-body">
                ...
                <p class="sn-lead sn-dialog-lead">
                    <%=GetGlobalResourceObject("ContentRestore", "Error")%><strong><asp:Label ID="LabelContent" runat="server" /></strong>
                </p>
    ...
    <FooterTemplate>
        <div class="sn-pt-body-border ui-widget-content sn-dialog-buttons">
            <div class="sn-pt-body">
                <asp:Button ID="NewNameBtn" runat="server" Text="<%$ Resources:ContentRestore,RestoreWithNewName %>" CommandName="RestoreWithNewName" CssClass="sn-submit" /> 
                <asp:Button ID="OkBtn" runat="server" Text="<%$ Resources:ContentRestore,Ok %>" CommandName="Ok" CssClass="sn-submit" /> 
            </div>
        </div>
        <div class="sn-pt-footer"></div>    
    </FooterTemplate>
