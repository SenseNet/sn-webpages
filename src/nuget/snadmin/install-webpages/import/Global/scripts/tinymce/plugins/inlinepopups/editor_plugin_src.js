...
//			f.top -= po.y;
			...
			t._addAll(DOM.doc.body, 
				['div', {id : id, role : 'dialog', 'aria-labelledby': f.type ? id + '_content' : id + '_title', 'class' : (ed.settings.inlinepopups_skin || 'clearlooks2') + (tinymce.isIE && window.getSelection ? ' ie9' : ''), style : 'width:100px;height:100px'}, 
					['div', {id : id + '_wrapper', 'class' : 'mceWrapper' + opt},
						...
						['a', { 'class': 'mceMove', tabindex: '-1', href: '#'}],
						['a', { 'class': 'mceMin', tabindex: '-1', href: '#', onmousedown: 'return false;'}],
						['a', { 'class': 'mceMax', tabindex: '-1', href: '#', onmousedown: 'return false;'}],
						['a', { 'class': 'mceMed', tabindex: '-1', href: '#', onmousedown: 'return false;'}],
						['a', { 'class': 'mceClose', tabindex: '-1', href: '#', onmousedown: 'return false;'}],
						['a', { id: id + '_resize_n', 'class': 'mceResize mceResizeN', tabindex: '-1', href: '#'}],
						['a', { id: id + '_resize_s', 'class': 'mceResize mceResizeS', tabindex: '-1', href: '#'}],
						['a', { id: id + '_resize_w', 'class': 'mceResize mceResizeW', tabindex: '-1', href: '#'}],
						['a', { id: id + '_resize_e', 'class': 'mceResize mceResizeE', tabindex: '-1', href: '#'}],
						['a', { id: id + '_resize_nw', 'class': 'mceResize mceResizeNW', tabindex: '-1', href: '#'}],
						['a', { id: id + '_resize_ne', 'class': 'mceResize mceResizeNE', tabindex: '-1', href: '#'}],
						['a', { id: id + '_resize_sw', 'class': 'mceResize mceResizeSW', tabindex: '-1', href: '#'}],
						['a', { id: id + '_resize_se', 'class': 'mceResize mceResizeSE', tabindex: '-1', href: '#'}]
					]
				]
			);
    ...
    DOM.add(id + '_wrapper', 'a', { id: id + '_ok', 'class': 'mceButton mceOk', href: '#', onmousedown: 'return false;' }, 'Ok');

				if (f.type == 'confirm')
				    DOM.add(id + '_wrapper', 'a', { 'class': 'mceButton mceCancel', href: '#', onmousedown: 'return false;' }, 'Cancel');
