...
<div id="CheckInDialog" class="sn-panel sn-hide">
    ...
    <div class="sn-panel sn-buttons">
        ...
        <input type="button" value='<%=GetGlobalResourceObject("Content", "Cancel") %>' class="sn-submit sn-notdisabled" onclick="javascript:$('#CheckInDialog').dialog('close');return false;" />
    </div>
</div>
