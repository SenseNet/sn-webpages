...
<div class="sn-content sn-content-inlineview">
    ...
    <sn:Image ID="Image1" CssClass="sn-avatar" runat="server" FieldName="Avatar" ControlMode="Edit">
        <browsetemplate>
            <asp:Image CssClass="sn-avatar" ImageUrl="/Root/Global/images/default-avatar.png" ID="ImageControl" runat="server" alt="<%$ Resources:Content,MissingImage %>" title="" />
        </browsetemplate>
    </sn:Image>
    <h2><%=GetGlobalResourceObject("Content", "ContactInformation")%></h2>
    ...
    <h2><%=GetGlobalResourceObject("Content", "Work")%></h2>
    ...
    <sn:DatePicker runat="server" FieldName="BirthDate" ControlMode="Edit"/>
    ...
    <sn:DropDown ID="DropDownLanguage" runat="server" FieldName="Language" ControlMode="Edit"/>
    <h2><%=GetGlobalResourceObject("Content", "Skills")%></h2>
    ...
    <h2><%=GetGlobalResourceObject("Content", "Community")%></h2>
