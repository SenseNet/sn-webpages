...
<div class="sn-user">
    <sn:Image ID="Image" runat="server" FieldName="Avatar" FrameMode="NoFrame">
        <EditTemplate>
            <div><asp:Image CssClass="sn-pic sn-pic-left" ImageUrl="/Root/Global/images/orgc-missinguser.png" Width="128" Height="128" ID="ImageControl" runat="server" alt="<%$ Resources:Content,MissingImage %>" title="" /></div>
...
<sn:ShortText runat="server" ID="ShortTextLoginName" FieldName="LoginName"/>
...
<sn:GenericFieldControl runat="server" ID="GenericFieldControl1" 
    ExcludedFields="Avatar Name LoginName FullName Enabled Password Email Domain Version Index" />
